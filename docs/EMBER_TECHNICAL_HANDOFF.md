...
Актуальный порядок всегда берётся из `docs/EMBER_NOW.md`. Сначала завершается
проектирование канонического graybox стартовой главы: связанная карта, точная
арена стража, квестовые и диалоговые состояния и минимальный набор assets. После
этого согласуется отдельный технический Task Contract реализации. До
канонического боя парой отдельно проектируется активная группа из 1–4 героев без
второго party/save owner. Парные техники остаются на своём authored-радиусе; их
